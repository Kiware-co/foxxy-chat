...
.widget-wrapper {
  ...
  --text-blue: 204 78 0; // FOXXY #cc4e00
  ...
  --solid-blue: 255 223 181; // FOXXY #ffdfb5
  ...
  --border-blue: 242, 121, 14, 0.5; // FOXXY #f2790e @ 50%
...
.dark .widget-wrapper {
  ...
  --solid-blue: 80 35 0; // FOXXY #502300
  --solid-iris: 38 42 101;
  --text-blue: 255 160 87; // FOXXY #ffa057
